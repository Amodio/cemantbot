...
`);
    ...
    async function loadPythonModel() {
        ...
        const fetchUrl = (window.location.hostname.split('.')[0] == 'cemantix' ? 'https://media.githubusercontent.com/media/Amodio/cemantbot/refs/heads/main/models/frWac_no_postag_phrase_500_cbow_cut10_stripped.bin' : 'https://raw.githubusercontent.com/Amodio/cemantbot/main/CEMANTLE/models/GoogleNews-vectors-negative300_stripped.bin');
